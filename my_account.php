...
<br>
    ...
    <label for="country"><strong>PASSWORD :</strong> </label>
 	<input type="password" id="ipassword" name="fpassword" value="<?php echo htmlspecialchars($_SESSION['user_password']); ?>" maxlength="15" required>
  	...
  	<br><br>
  	<div class="wrap">
    <div class='element'><input type="submit" name="submit" value="Sauvegarder"></div>
...
<br>
<?php
// On récupère tout le contenu de la table transactions correspondant a l'user id
...
$s = $select->fetch(PDO::FETCH_OBJ);
	...
	if(empty($s["id"])){ //On check si le retour est vide
			...
			echo '<h1 style="color:#fd7a01;"> Aucune transaction enregistrée </h1>';
