...
<?php //Gestion des produits de la boutique
...
<div class="wrap">
<div class='element'><button type="button" class="button2">En stock : <?php echo $s->stock; ?></button></div> 
<?php if ($s->stock>0){ ?><span id="myLink"><a href="panier.php?action=ajout&amp;l=<?php echo $s->slug; ?>&amp;q=1&amp;p=<?php echo $s->price; ?>">Ajouter au panier</a></span><?php }else{echo'<h5 style="color:red;">Stock épuisé !</h5>';} ?>
</div>
...
<div id="left">
    ...
    <ul>
        <li>
            <div class="img"><a href="?show=<?php echo $s->slug; ?>"><img src="imgs/<?php echo $s->slug; ?>.jpg"/></a></div>
            <div class="info">
